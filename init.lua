...
-- Don't show the command line unless it is used
vim.o.cmdheight = 0
...
vim.keymap.set('n', '<S-L>', ':bn<CR>', { desc = 'Go to the next buffer' })
vim.keymap.set('n', '<S-H>', ':bp<CR>', { desc = 'Go the previous buffer' })
